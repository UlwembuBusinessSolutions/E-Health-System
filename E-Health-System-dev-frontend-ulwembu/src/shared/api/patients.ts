...
// Sent only after the user explicitly changes the read-only demographic
// record. The API creates an audited before/after snapshot for each change.
export interface UpdatePatientPayload extends RegisterPatientPayload {}
