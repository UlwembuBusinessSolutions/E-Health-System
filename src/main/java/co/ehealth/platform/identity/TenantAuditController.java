...
public class TenantAuditController {
    ...
    public ResponseEntity<Map<String, Object>> list(
        ...
        Map<UUID, String> namesByUserId =
                staffService.resolveUserNames(userIds);
    ...
    /**
     * Read-only CSV export of the audit trail.
     *
     * Uses exactly the same filter criteria as the audit listing endpoint.
     * Export generation itself is recorded as an AUDIT_EXPORT event.
     */
    @GetMapping(
            value = "/api/v1/audit/export",
            produces = "text/csv")
    ...
    public record AuditEntryResponse(
        ...
        static AuditEntryResponse from(
                AuditLog row,
                String userName) {
