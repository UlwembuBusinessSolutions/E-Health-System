...
public class DevSeedDataRunner implements ApplicationRunner {
        ...
        private void seedTenantData(UUID adminUserId) {
                ...
                Facility satelliteClinic = facilityService.create("Demo Satellite Clinic", "DEMO-02",
                                FacilityType.CLINIC,
                ...
                createStaffMember(mainClinic.getId(), "Pharmacist", "Rendani", "Nemukula",
                                ...
                                Gender.MALE, LocalDate.of(1988, 7, 20), "Pharmacy", "Pharmacist-in-Charge",
                                adminUserId);
                ...
                createStaffMember(satelliteClinic.getId(), "Facility Manager", "Lindiwe", "Zulu",
                                ...
                                Gender.FEMALE, LocalDate.of(1983, 9, 30), "Management", "Facility Manager",
                                adminUserId);
                ...
                try {
                        ...
                        registerPatient("Andile", "Ngcobo", LocalDate.of(1978, 6, 14), 6001,
                                        "18 Vilakazi Street, Soweto", "+27831112201", "Discovery Health", "DH-778812",
                                        adminUserId);
                        registerPatient("Busisiwe", "Mthembu", LocalDate.of(1995, 2, 3), 1002,
                                        "5 Nelson Mandela Drive, Johannesburg", "+27831112202", null, null,
                                        adminUserId);
                        registerPatient("Kagiso", "Modise", LocalDate.of(1960, 11, 22), 6003,
                                        "22 Freedom Square, Soweto", "+27831112203", "Bonitas", "BN-441290",
                                        adminUserId);
                        ...
                        registerPatient("Sibusiso", "Radebe", LocalDate.of(2001, 4, 30), 6005,
                                        "31 Chris Hani Road, Johannesburg", "+27831112205", "Momentum Health",
                                        "MH-556723", adminUserId);
                } finally {
        ...
        private UUID createStaffMember(UUID facilityId, String roleName, String firstName, String lastName,
                ...
                User user = staffService.createStaff(new StaffService.CreateStaffCommand(
                                firstName, lastName, employeeNumber, idNumber, email, contactNumber, gender,
                                dateOfBirth,
        ...
        // private void registerPatient(String firstName, String lastName, LocalDate
        // dateOfBirth, int genderSequence,
        ...
        // firstName, lastName, idNumber, address, contactNumber, medicalAidProvider,
        // medicalAidNumber),
        // registeredByUserId);
        // }
        ...
        private void registerPatient(String firstName, String lastName, LocalDate dateOfBirth, int genderSequence,
                ...
                String idNumber = southAfricanIdNumber(dateOfBirth, genderSequence);
                patientService.register(new PatientService.RegisterPatientCommand(
                                firstName, lastName, idNumber, null, null, null, null,
                                address, contactNumber, medicalAidProvider, medicalAidNumber),
                                registeredByUserId);
        }
